...
public class GamePanel extends JPanel implements ActionListener{
    ...
    public void startGame()
    {
        ...
        {
            //x[i] = screen_witdh / 2 - i * unit_size;
            //y[i] = screen_height / 2;
   ...
   public void checkCollisions()
    ...
    public void gameOver(Graphics g)
    {
       ...
       //g.setColor(new Color(random.nextInt(225),random.nextInt(225),random.nextInt(225)));
        ...
        g.setColor(Color.red);
        g.setColor(new Color(45,158,89));
        g.setFont(new Font("INK Free",Font.BOLD,50));
        FontMetrics metrics3= getFontMetrics(g.getFont());
        g.drawString("Press ENTER to play again", (screen_witdh - metrics3.stringWidth("Press ENTER to play again"))/2, screen_height/2+100);
    ...
    private void restartGame() {
        ...
        direction = 'R';
        running = true;
        startGame(); // Call the startGame method to resume the game
    }
